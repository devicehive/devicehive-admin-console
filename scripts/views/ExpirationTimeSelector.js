/*
  ...
  */
app.Views.ExpirationTimeSelector = Backbone.Marionette.ItemView.extend({
    triggers: {
    ...
    template: "expiration-time-selector",
    ...
    setDay: function () {
        this.model.set("endDate", (new Date()).addDays(+1));
    },
    setWeek: function () {
        this.model.set("endDate", (new Date()).addDays(+7));
    },
    setMonth: function () {
        this.model.set("endDate", (new Date()).addDays(+30));
    },
    setYear: function () {
        this.model.set("endDate", (new Date()).addDays(+365));
    }
});
