...
app.hints = {
    ...
    deviceTypesHintsAdmin: [
        {
            'next tr:first': 'You can check your Device Typess list',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        },
        {
            'click .add-new-device-type': 'Click to create your own new Device Type',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        },
        {
            'next a[data-path="devices"]': 'To create new device push this button please',
    ...
    deviceTypesHintsClient: [
        {
            'next .device-types-table': 'You can check your Device types list',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        },
        {
            'next a[data-path="devices"]': 'To create new device push this button please',
    ...
    userDeviceTypesHintsAdmin: [
        {
            'next #registered-device-types': 'Select device type to grant user access',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        },
        {
            'click .accept': 'Grant user access for selected device type',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        },
        {
            'next tbody tr:first': 'Observe device types available for user.',
            'skipButton': {className: 'customSkipBtn', text: 'Skip tutorial'}
        }
    ]
